const TermsAndConditions = () => {
  return (
    <div style={containerStyle}>
      <h1 style={tac}>WordPunz Print on Demand Terms and Conditions</h1>
      <p>
        Welcome to WordPunz Print on Demand ("WordPunz," "we," "our," or
      ...
      <div style={sectionStyle}>
        ...
        <p>
          1.1. WordPunz Print on Demand is an online platform that allows
      ...
      <div style={sectionStyle}>
        ...
        <p>
          2.1. WordPunz is a platform designed for showcasing personalized
          designs. The designs presented on this website are owned by WordPunz
          and intended for display and demonstration purposes only. They
        ...
        <p>
          ...
          of the designs showcased on WordPunz remain with WordPunz.
        </p>
        <p>
          2.3. Users may not use, reproduce, distribute, or modify the showcased
          designs without the prior written consent of WordPunz. Any
      ...
      <div style={sectionStyle}>
        ...
        <p>
          ...
          are owned or licensed by WordPunz.
        </p>
        <p>
      ...
      <div style={sectionStyle}>
        ...
        <p>
          5.1. WordPunz reserves the right to modify these Terms at any time
